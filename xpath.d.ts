...
export interface SelectFn {
    ...
    (xpathText: string, contextNode: Node, single: true): Node | boolean | number | string;
    (xpathText: string, contextNode: Node): Node[] | Node | boolean | number | string;
    (xpathText: string, contextNode: Node, single?: boolean): Node[] | Node | boolean | number | string;
}

export var select: SelectFn;
 ...
 * @param contextNode
 */
export function select1(xpathText: string, contextNode: Node): Node | boolean | number | string;
 ...
 * @param single If true and the evaluation result is one or more Nodes, will return only the first Node instead of an Array<Node>
 */
export function selectWithResolver(xpathText: string, contextNode: Node, resolver: XPathNSResolver, single?: boolean): Node[] | Node | boolean | number | string;
 ...
 */
export function evaluate(xpathText: string, contextNode: Node, resolver?: XPathNSResolver, resultType?: number, result?: XPathResult): XPathResult;
 ...
 */
export function useNamespaces(namespaceMappings: NamespaceMap): typeof select;
 ...
 */
export function createExpression(xpathText: string, namespaceURLMapper: XPathNSResolver): XPathExpression;

/**
 * Create an XPathNSResolver that resolves based on the information available in the context of a DOM node.
 * @param node
 */
export function createNSResolver(node: Node): XPathNSResolver;
